...
create table if not exists products (
    ...
    -- diagnóstico de degradação do conector (sem credencial, API
    -- recusou, product_id não encontrado) — ver 0008
    aviso             text,
...
-- ============================================================
-- 0008 + 0009 + 0010 + 0011 — dança/Dilg também no reset:
-- products.aviso já está no CREATE TABLE de products (0008);
-- aqui entram os módulos novos da feature de divulgação.
-- ============================================================
